...
export const metadata: Metadata = {
  ...
  description: "Divbuy terms and conditions for using our services.",
};

export default function TermsOfServicePage() {
  return (
    <div className="bg-white">
      <section className="bg-gradient-to-r from-gray-900 to-emerald-900 text-white py-12">
      ...
      <section className="py-14">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose pemerald-gray max-w-none space-y-8">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">1. Agreement to Terms</h2>
              <p className="text-gray-600">
                By accessing or using Divbuy&apos;s website and services, you agree to be bound by these Terms of Service. If you disagree with any part, you may not access our services.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Divbuy Ltd provides wholesale electronics and tech gadgets. All products are subject to availability. We reserve the right to modify or discontinue products without notice. Prices are subject to change.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Divbuy Ltd shall not be liable for any indirect, incidental, or consequential damages arising from use of our products or services. Our total liability shall not exceed the amount paid for the specific product or service.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                All content on this website, including text, graphics, logos, and images, is the property of Divbuy Ltd and protected by intellectual property laws. Unauthorised use is prohibited.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Divbuy Ltd<br />
                15 Crown Business Park, Leeds, LS12 6AH<br />
                United Kingdom<br />
                Email: info@divbuy.com<br />
                VAT: GB 516 2847 39<br />
