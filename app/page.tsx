...
export default function Home() {
  return (
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-gray-900 via-emerald-900 to-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <span className="text-emerald-400 text-sm font-medium">Wholesale Tech Supplier</span>
              <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-5">
                Premium Tech, <span className="text-emerald-400">Best Prices</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/products" className="px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-medium rounded-lg">
                  View Products
                </Link>
      ...
      {/* Mobile Stats */}
      <section className="md:hidden py-8 bg-emerald-50">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-4 gap-2 text-center">
          {[
            ...
            <div key={i}>
              <div className="text-lg font-bold text-emerald-600">{s.n}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <Link key={i} href={c.h} className="p-4 bg-gray-50 rounded-xl text-center hover:bg-emerald-50 hover:ring-2 hover:ring-emerald-200 transition-all">
      ...
      <section className="py-16 md:py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-10">Why Divbuy?</h2>
      ...
      <section className="py-16 md:py-20 bg-emerald-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-emerald-100 mb-8">Contact us for a personalised quote. No minimum for first orders.</p>
          <Link href="/contact" className="inline-block px-8 py-3 bg-white text-emerald-600 font-semibold rounded-lg hover:bg-emerald-50">
            Request Quote
          </Link>
          <p className="text-emerald-200 text-sm mt-4">Or email info@divbuy.com</p>
        </div>
      </section>
    </div>
  );
